    ...
    <div className="flex items-center justify-center min-h-screen bg-background p-4">
      <Card className="w-full max-w-md">
        ...
        <CardContent className="text-center text-muted-foreground">
          <p>
            This area is restricted to authorized users only. If you believe you should have access, please contact your
            administrator or try logging in with different credentials.
          </p>
        </CardContent>
